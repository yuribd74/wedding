<?php
add_action( 'vc_before_init', 'dt_sc_models_with_filter_vc_map' );
function dt_sc_models_with_filter_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__("Filterable Models", "veda-model"),
		"base" => "dt_sc_models_with_filter",
		"icon" => "dt_sc_models_with_filter",
		"category" => $plural_name,
		'description' => esc_html__("To show models with filterable option", "veda-model"),
		"params" => array(

			array(
				'type' => 'textfield',
				'heading' => esc_html__( 'Title', 'veda-model' ),
				'param_name' => 'title',
				'description' => esc_html__('Enter title','veda-model')				
			),
			...
			array( 
				...
				'description' => esc_html__( 'Select filterable models display layout.', 'veda-model' )				
			)
		)
	) );
}?>