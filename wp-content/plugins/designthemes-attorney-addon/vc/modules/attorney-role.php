<?php
add_action( 'vc_before_init', 'dt_sc_current_attorney_role_vc_map' );
function dt_sc_current_attorney_role_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__("Attorney Role", "veda-attorney"),
		"base" => "dt_sc_current_attorney_role",
		"icon" => "dt_sc_current_attorney_role",
		"category" => $plural_name,
		'description' => esc_html__("Role of current attorney", "veda-attorney"),
		"params" => array(
          	array(
          		'type' => 'textfield',
