<?php
add_action( 'vc_before_init', 'dt_sc_current_attorney_info_vc_map' );
function dt_sc_current_attorney_info_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__("Attorney Info", "veda-attorney"),
		"base" => "dt_sc_current_attorney_info",
		"icon" => "dt_sc_current_attorney_info",
		"category" => $plural_name,
		'description' => esc_html__("Information of current attorney", "veda-attorney"),
		"params" => array(
          	array(
          		'type' => 'textfield',
