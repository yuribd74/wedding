<?php
add_action( 'vc_before_init', 'dt_sc_university_recent_courses_vc_map' );
function dt_sc_university_recent_courses_vc_map() {

	vc_map( array(
		"name" => esc_html__("Recent Courses", "veda-university"),
		'description' => esc_html__("To show recent courses", "veda-university"),
		"base" => "dt_sc_university_recent_courses",
		"icon" => "dt_sc_university_recent_courses",
