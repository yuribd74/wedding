<?php	global $post;
	...
	echo '<input type="hidden" name="dt_theme_yoga_teacher_meta_nonce" value="'.wp_create_nonce('dt_theme_yoga_teacher_nonce').'" />';?>
<!-- 0. Sub Title -->
...
<div class="custom-box">
    <div class="column one-sixth">
        <label><?php esc_html_e('Social Profile','veda-yoga');?> </label>
    </div>
    <div class="column five-sixth last">
        ...
        <p class="note"> <?php esc_html_e("You can given social shortcode. eg: [dt_sc_social facebook='#' twitter='#'/]",'veda-yoga');?> </p>
    </div>
</div>

<div class="custom-box meta-fields">
    <div class="column one-sixth">
        <label><?php esc_html_e('Phone No','veda-yoga');?> </label>
    </div>
    <div class="column five-sixth last">
...
<?php   // checking meta files from back-end
    $fields = veda_opts_get( 'yoga-teacher-custom-fields', array() );
    $fields = array_unique(array_filter($fields));
    
    if(!empty($fields)) : ?>
        <div class="custom-box">
            <div class="column one-sixth">
                <label><?php esc_html_e('Additional Fields','veda-yoga');?></label>
            </div>
            <div class="column five-sixth last">
                <div class="meta-fields">
                    <div class="column one-fourth">
                        <strong><?php esc_html_e('Title','veda-yoga');?></strong>
                    </div>
                    <div class="column three-fourth last">
                        <strong><?php esc_html_e('Value','veda-yoga');?></strong>
                    </div>
                ...
                <p class="note"> <?php esc_html_e("Here you can change Additional field title & values for this item. First two fields will be shown in hover",'veda-yoga');?> </p>
            </div>        
        </div><?php 
